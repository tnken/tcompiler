...
func TestCompile(t *testing.T) {
	cases := []struct {
		...
		{"def myFunc() 2+3 end", []byte{0, 3, 0, 0, 2, 0, 2, 0, 0, 2, 0, 3, 1, 0, 0, 7, 0, 0, 1, 0, 0, 2, 1, 0, 6, 0, 0, 3, 11, 0, 5}},
		{"def myFunc() return 2+3 end myFunc()", []byte{0, 3, 0, 0, 2, 0, 2, 0, 0, 2, 0, 3, 1, 0, 0, 8, 0, 0, 1, 0, 0, 2, 1, 15, 0, 10, 0, 0, 3, 11, 0, 10, 0, 14, 0, 5}},
	}
	...
	cases2 := []struct {
		...
		{"def myFunc() a = 1 return a end b = 3 b+myFunc()", Bytecode{[2]byte{0, 3}, []byte{0, 0, 2, 0, 1, 1, 0, 0, 8, 0, 0, 1, 17, 0, 16, 0, 15, 0, 0, 2, 0, 3}, [2]byte{0, 18}, []byte{0, 0, 2, 11, 0, 0, 0, 3, 11, 1, 10, 1, 10, 0, 14, 0, 1, 5}}},
		// 		{`23
		// class LED
